					...
					if($('#upload').val()) {
						...
						$(this).ajaxSubmit({ 
							...
							uploadProgress: function (event, position, total, percentComplete){	
								...
								$("#progress").html('<div id="status">' + percentComplete +' %</div>')
							},
							success:function (){
								//$('#loader-icon').hide();
					...
					<!-- <div class="w3-container">
				     The Modal
				      <div class="w3-card-8">class="w3-input w3-blue"-->
						...
						<form id="uploadForm"  class="w3-modal-content" action=" " method="post" enctype="multipart/form-data">
							<div class=" w3-container">	
								<label for="upload"><div class="box">+</div></label>
								<input type="file" multiple="multiple" id="upload" name="upload" style="display: none;">
								<input class="w3-input w3-border w3-margin-top" placeholder="Description.." type="text" id="desc" name="desc" maxlength="255">
								<input type="hidden" name="action" value="upload">
								<input class="w3-right w3-btn w3-blue w3-margin-top w3-margin-bottom"  id="btnSubmit" type="submit" value="Upload">
							</div>
						</form>
						<div id="progressBar"></div>
						<footer class=" w3-container">
							<div id="bar_blank" class="w3-progress-container">
							<div id="progress-bar" class="w3-progressbar w3-green">
							<div id="progress" class="w3-center w3-text-white"></div></div></div><!---->
						</footer>
